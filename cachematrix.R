## [Spanish]
## Estas dos funciones permitiran guardar el resultado de la
## inversa de una matriz en la memoria cache evitando asi
## que r realiace el calculo cada vez que se solicite dicha informacion,
## de esta forma ahorramos tiempo y costo computacional
